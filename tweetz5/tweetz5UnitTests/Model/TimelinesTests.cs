...
namespace tweetz5UnitTests.Model
{
    ...
    public class TimelinesTests
    {
        ...
        public void HomeTimeline()
        {
            ...
            mockWebRequest.Setup(request => request.GetResponse()).Returns(mockWebResponse.Object);
        ...
        [TestMethod]
        public void TweetWithMentionIsTaggedAsMentioned()
        {
            OAuth.TestUserName = "mikeward_aa";
            try
            {
